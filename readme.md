...
[GitHub:](https://github.com/mcroo20/cordova-plugin-mediaPicker) https://github.com/mcroo20/cordova-plugin-mediaPicker</br>
...
```
  cordova plugin add https://github.com/mcroo20/cordova-plugin-mediaPicker.git --variable IOS_PHOTO_LIBRARY_USAGE_DESCRIPTION="your usage message"
```
